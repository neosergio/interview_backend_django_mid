...
from interview.inventory.views import (
    InventoryItemList, InventoryLanguageListCreateView,
...
urlpatterns = [
    ...
    path('created_after/<str:created_after_date>/', InventoryItemList.as_view(), name='inventory-list-created-after-date'),
]